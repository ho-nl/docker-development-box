...
PHPS='php@8.4 php@8.3 php@8.2 php@8.1 php@7.4 php@7.3 php@7.2'
...
install_php() {
  ...
  [ $PHPVERSION == '8.3' ] && XDEBUG_VERSION='3.4.4'
  [ $PHPVERSION == '8.4' ] && XDEBUG_VERSION='3.4.4'
  ...
  [ $PHPVERSION = '8.3' ] && PHP_EXTENSION_API='20230831'
  [ $PHPVERSION = '8.4' ] && PHP_EXTENSION_API='20240924'
